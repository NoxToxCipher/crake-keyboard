...
pub const WIKIPEDIA_COMMON_TYPOS: &[(&str, &str)] = &[
    ...
    ("conscruct", "construct"),
    ("conscructed", "constructed"),
    ("conscructing", "constructing"),
    ("conscruction", "construction"),
    ("conscructions", "constructions"),
    ("conscructs", "constructs"),
    ...
    ("inquiry", "inquiry"),
    ("inscruct", "instruct"),
    ("inscructed", "instructed"),
    ("inscructing", "instructing"),
    ("inscruction", "instruction"),
    ("inscructions", "instructions"),
    ("inscructs", "instructs"),
    ...
    ("obscruct", "obstruct"),
    ("obscructed", "obstructed"),
    ("obscructing", "obstructing"),
    ("obscruction", "obstruction"),
    ("obscructions", "obstructions"),
    ("obscructs", "obstructs"),
    ("obsession", "obsession"),
    ("obsticle", "obstacle"),
    ("obsticles", "obstacles"),
    ...
    ("warrant", "warrant"),
    ("warranty", "warranty"),
    ("was ter egg", "easter egg"),
    ("waster", "easter"),
    ("waster egg", "easter egg"),
    ("we", "we"),
    ("weather", "weather"),
    ("wednesday", "wednesday"),
    ("weird", "weird"),
...
#[inline]
/// British/Australian spellings and plain words that the Wikipedia table
/// listed as "typos" were removed on 2026-09-18 (favourite, neighbour,
/// judgement, criticise, alright, owed, fins, lite, mt, whiskey, nite,
/// aight, planing, ...). The engine also refuses a key that is a
/// dictionary word at corpus >= 160; that floor is a frequency proxy, so a
/// real word under it must be removed from this table by hand.
