...
// 2026-09-18 hunt: also suggestion-only — codes one slip from a top-band
// word (np/no, gl/go, bf/be, rn/run, nw/now, ty/try, yt/yet, op/top,
// irl/girl, cu/cut, tg/tv, rt/art), codes that are shipped words (asap,
// faq, nsfw, stfu, yolo), and spelled-out profanity (ffs, fml, omfg, idgaf,
// htf, ptfo): people abbreviate those on purpose. Brand casing: YouTube,
// Facebook. Typed ALL-CAPS codes never expand (see the shorthand arm).
// Suggestion-only codes (2026-09-13 sweep): a code that is itself a common
// word (aka, rip, til, sec, wtf) or one adjacent-key slip from a top-tier
// word (alr/all, atm/at, dnd/end, eta/eat, idts/its, ofc/off, otp/top,
// sup/up, json/son, wth/with, ik/ok) must never auto-expand on space —
// "rip" became "rest in peace" and "with" mistyped as "wth" became "what
// the hell". The expansion stays one tap away in the strip.
pub const SHORTHAND_LEXICON: &[ShorthandEntry] = &[
    ...
    ShorthandEntry { code: "aka", expansion: "also known as", is_autocorrect: false },
    ShorthandEntry { code: "alr", expansion: "already", is_autocorrect: false },
    ShorthandEntry { code: "api", expansion: "API", is_autocorrect: true },
    ShorthandEntry { code: "asap", expansion: "as soon as possible", is_autocorrect: false },
    ShorthandEntry { code: "atm", expansion: "at the moment", is_autocorrect: false },
    ...
    ShorthandEntry { code: "bcuz", expansion: "because", is_autocorrect: true },
    ShorthandEntry { code: "bf", expansion: "boyfriend", is_autocorrect: false },
    ...
    ShorthandEntry { code: "cu", expansion: "see you", is_autocorrect: false },
    ...
    ShorthandEntry { code: "def", expansion: "definitely", is_autocorrect: false },
    ...
    ShorthandEntry { code: "dnd", expansion: "do not disturb", is_autocorrect: false },
    ShorthandEntry { code: "eta", expansion: "estimated time of arrival", is_autocorrect: false },
    ShorthandEntry { code: "eth", expansion: "ETH", is_autocorrect: true },
    ShorthandEntry { code: "faq", expansion: "frequently asked questions", is_autocorrect: false },
    ShorthandEntry { code: "fb", expansion: "Facebook", is_autocorrect: true },
    ShorthandEntry { code: "ffs", expansion: "for fuck's sake", is_autocorrect: false },
    ShorthandEntry { code: "fml", expansion: "fuck my life", is_autocorrect: false },
    ...
    ShorthandEntry { code: "gl", expansion: "good luck", is_autocorrect: false },
    ...
    ShorthandEntry { code: "hmu", expansion: "hit me up", is_autocorrect: true },
    ShorthandEntry { code: "hru", expansion: "how are you", is_autocorrect: true },
    ShorthandEntry { code: "htf", expansion: "how the fuck", is_autocorrect: false },
    ...
    ShorthandEntry { code: "idgaf", expansion: "I don't give a fuck", is_autocorrect: false },
    ShorthandEntry { code: "idk", expansion: "I don't know", is_autocorrect: true },
    ShorthandEntry { code: "idts", expansion: "I don't think so", is_autocorrect: false },
    ShorthandEntry { code: "iirc", expansion: "if I remember correctly", is_autocorrect: true },
    ShorthandEntry { code: "ik", expansion: "I know", is_autocorrect: false },
    ...
    ShorthandEntry { code: "irl", expansion: "in real life", is_autocorrect: false },
    ...
    ShorthandEntry { code: "json", expansion: "JSON", is_autocorrect: false },
    ...
    ShorthandEntry { code: "np", expansion: "no problem", is_autocorrect: false },
    ShorthandEntry { code: "nsfw", expansion: "not safe for work", is_autocorrect: false },
    ShorthandEntry { code: "nvm", expansion: "never mind", is_autocorrect: true },
    ShorthandEntry { code: "nw", expansion: "no worries", is_autocorrect: false },
    ShorthandEntry { code: "ofc", expansion: "of course", is_autocorrect: false },
    ShorthandEntry { code: "omfg", expansion: "oh my fucking god", is_autocorrect: false },
    ...
    ShorthandEntry { code: "op", expansion: "original poster", is_autocorrect: false },
    ShorthandEntry { code: "otp", expansion: "OTP", is_autocorrect: false },
    ...
    ShorthandEntry { code: "prob", expansion: "probably", is_autocorrect: false },
    ShorthandEntry { code: "prolly", expansion: "probably", is_autocorrect: true },
    ShorthandEntry { code: "ptfo", expansion: "passed the fuck out", is_autocorrect: false },
    ...
    ShorthandEntry { code: "rip", expansion: "rest in peace", is_autocorrect: false },
    ShorthandEntry { code: "rlly", expansion: "really", is_autocorrect: true },
    ShorthandEntry { code: "rn", expansion: "right now", is_autocorrect: false },
    ShorthandEntry { code: "rofl", expansion: "rolling on the floor laughing", is_autocorrect: true },
    ShorthandEntry { code: "rt", expansion: "retweet", is_autocorrect: false },
    ShorthandEntry { code: "sec", expansion: "second", is_autocorrect: false },
    ShorthandEntry { code: "sfw", expansion: "safe for work", is_autocorrect: true },
    ShorthandEntry { code: "smh", expansion: "shaking my head", is_autocorrect: true },
    ShorthandEntry { code: "sometm", expansion: "sometime", is_autocorrect: true },
    ...
    ShorthandEntry { code: "sry", expansion: "sorry", is_autocorrect: true },
    ShorthandEntry { code: "ssh", expansion: "SSH", is_autocorrect: true },
    ShorthandEntry { code: "stfu", expansion: "shut the fuck up", is_autocorrect: false },
    ShorthandEntry { code: "sup", expansion: "what's up", is_autocorrect: false },
    ...
    ShorthandEntry { code: "tg", expansion: "thank goodness", is_autocorrect: false },
    ...
    ShorthandEntry { code: "til", expansion: "today I learned", is_autocorrect: false },
    ...
    ShorthandEntry { code: "tmrw", expansion: "tomorrow", is_autocorrect: true },
    ...
    ShorthandEntry { code: "txt", expansion: "text", is_autocorrect: true },
    ShorthandEntry { code: "ty", expansion: "thank you", is_autocorrect: false },
    ...
    ShorthandEntry { code: "wknd", expansion: "weekend", is_autocorrect: true },
    ShorthandEntry { code: "wtf", expansion: "what the fuck", is_autocorrect: false },
    ShorthandEntry { code: "wth", expansion: "what the hell", is_autocorrect: false },
    ...
    ShorthandEntry { code: "yolo", expansion: "you only live once", is_autocorrect: false },
    ShorthandEntry { code: "yt", expansion: "YouTube", is_autocorrect: false },
